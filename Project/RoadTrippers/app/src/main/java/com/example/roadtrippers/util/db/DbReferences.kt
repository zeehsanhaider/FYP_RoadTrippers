package com.example.roadtrippers.util.db
...
object DbReferences {
    ...
    private const val TRIP_TICKETS_DB_TITLE = "TRIP-TICKETS"
    ...
    lateinit var tripTicketsDbRef: DatabaseReference
    ...
    fun initDatabaseReferences() {
        ...
        tripTicketsDbRef = FirebaseDatabase.getInstance().getReference(TRIP_TICKETS_DB_TITLE)
